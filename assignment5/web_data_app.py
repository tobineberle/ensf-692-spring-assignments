...
def book_data():
    ...
    book_data["Reduced Price"] = book_data['Prices'] * .75
...
def learn():
    ...
    content = """
I learnt a lot about data manipulation and analysis using Pandas! There is so much content there to learn!
"""
    return content
